...
class TestPriceUpdate:
    ...
    def test_price_update_creation(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=190.50, previous_price=190.00, open_price=188.00, timestamp=1234567890.0
        )
    ...
    def test_change_calculation(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=190.50, previous_price=190.00, open_price=190.00, timestamp=1234567890.0
        )
    ...
    def test_change_negative(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=189.50, previous_price=190.00, open_price=190.00, timestamp=1234567890.0
        )
        assert update.change == -0.50
    ...
    def test_change_percent_up(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=190.00, previous_price=100.00, open_price=100.00, timestamp=1234567890.0
        )
    ...
    def test_change_percent_down(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=100.00, previous_price=200.00, open_price=200.00, timestamp=1234567890.0
        )
    ...
    def test_change_percent_zero_previous(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=100.00, previous_price=0.00, open_price=0.00, timestamp=1234567890.0
        )
    ...
    def test_direction_up(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=191.00, previous_price=190.00, open_price=190.00, timestamp=1234567890.0
        )
    ...
    def test_direction_down(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=189.00, previous_price=190.00, open_price=190.00, timestamp=1234567890.0
        )
    ...
    def test_direction_flat(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=190.00, previous_price=190.00, open_price=190.00, timestamp=1234567890.0
        )
    ...
    def test_to_dict(self):
        ...
        update = PriceUpdate(
            ticker="AAPL", price=190.50, previous_price=190.00, open_price=189.00, timestamp=1234567890.0
        )
